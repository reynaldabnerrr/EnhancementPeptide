...
export default function Home() {
  ...
  return (
    <LanguageProvider>
    <main className="min-h-screen bg-[#080A09] text-[#F8FAFC] selection:bg-[#2CE58D] selection:text-black">
      ...
      <section id="specimen" className="py-12 bg-[#080A09] border-y border-[#1E2923]">
      ...
      <section id="calculator" className="py-20 bg-[#080A09] relative border-y border-[#1E2923]">
